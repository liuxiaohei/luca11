...
public class Hex {
    ...
    public static class DecoderException extends Exception {
        ...
        public DecoderException(String message, Throwable cause, boolean enableSuppression,
    ...
    public static class EncoderException extends Exception {
        ...
        public EncoderException(String message, Throwable cause, boolean enableSuppression,
                                boolean writableStackTrace) {
            super(message, cause, enableSuppression, writableStackTrace);
        }
    }
