...
public class ReactiveMySqlApplication {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String url1 = "jdbc:mysql://127.0.0.1/luca?user=root&password=12345678";
        Configuration configuration = URLParser.INSTANCE.parseOrDie(url1, StandardCharsets.UTF_8);
